...
class MetamaskProvider extends ethereum_generic_provider_1.GenericProvider {
    ...
    constructor(options) {
        super(Object.assign({}, options, { signMethod: ethereum_generic_provider_1.SignMethod.PERSONAL_SIGN }));
        if (this.isSupported()) {
            this.installClient();
            this.installEvents();
        }
    ...
    installClient() {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof window['ethereum'] !== 'undefined') {
                ...
                this._client = Object.assign({}, window['web3']['currentProvider'], { send(payload, callback) {
