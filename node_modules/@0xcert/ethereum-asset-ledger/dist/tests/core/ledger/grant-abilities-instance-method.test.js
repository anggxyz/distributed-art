...
spec.test('grants ledger abilities for an account', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const ledger = ctx.get('ledger');
    const bob = ctx.get('bob');
    yield ledger.grantAbilities(bob, [scaffold_1.GeneralAssetLedgerAbility.CREATE_ASSET, scaffold_1.GeneralAssetLedgerAbility.TOGGLE_TRANSFERS]);
...
spec.test('grants ledger abilities to an order gateway', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const ledger = ctx.get('ledger');
