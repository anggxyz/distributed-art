...
spec.test('returns token approved account', (ctx) => __awaiter(this, void 0, void 0, function* () {
...
spec.test('returns null calling a contract that does not have getApprovedAccount function', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const provider = ctx.get('provider');
