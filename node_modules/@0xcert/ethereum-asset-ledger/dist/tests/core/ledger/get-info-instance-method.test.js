...
spec.test('returns ledger info (Xcert smart contract)', (ctx) => __awaiter(this, void 0, void 0, function* () {
...
spec.test('returns ledger info (erc721 metadata smart contract)', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const provider = ctx.get('provider');
