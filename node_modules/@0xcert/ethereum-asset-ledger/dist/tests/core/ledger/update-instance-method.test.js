...
spec.test('update uri base', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcert;
    const ledger = ctx.get('ledger');
    yield ledger.update({
        uriBase: 'http://new.com/',
    });
    ctx.is(yield xcert.instance.methods.uriBase().call(), 'http://new.com/');
}));
exports.default = spec;
//# sourceMappingURL=update-instance-method.test.js.map