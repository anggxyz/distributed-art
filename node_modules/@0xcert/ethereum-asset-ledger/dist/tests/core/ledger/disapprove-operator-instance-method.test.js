...
spec.test('disapproves operator', (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield ledger.disapproveOperator(bob);
    ctx.false(yield xcert.instance.methods.isApprovedForAll(coinbase, bob).call());
}));
spec.test('disapproves order gateway proxy as operator', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcert;
    const ledger = ctx.get('ledger');
    ...
    yield ledger.disapproveOperator(gateway);
    ctx.false(yield xcert.instance.methods.isApprovedForAll(coinbase, proxyId).call());
}));
