...
spec.test('returns account that owns the asset', (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    ctx.is(yield ledger.getAssetAccount('1'), coinbase);
}));
spec.test('returns null calling getAssetAccount function on a contract that does not support it', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const coinbase = ctx.get('coinbase');
    const provider = ctx.get('provider');
    const ledgerId = ctx.get('protocol').xcert.instance.options.address;
    const ledger = new ledger_1.AssetLedger(provider, ledgerId);
...
//# sourceMappingURL=get-asset-account-instance-method.test.js.map