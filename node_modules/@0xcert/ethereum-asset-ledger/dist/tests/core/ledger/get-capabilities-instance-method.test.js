...
spec.test('returns ledger capabilities', (ctx) => __awaiter(this, void 0, void 0, function* () {
...
spec.test('returns empty ledger capabilities for erc721 smart contract', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const provider = ctx.get('provider');
