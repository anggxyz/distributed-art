...
spec.test('transfer asset', (ctx) => __awaiter(this, void 0, void 0, function* () {
...
spec.test('transfer asset to a contract', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcert;
    const ledger = ctx.get('ledger');
    const coinbase = ctx.get('coinbase');
...
spec.test('transfer asset to a contract with data', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcert;
    const ledger = ctx.get('ledger');
    const coinbase = ctx.get('coinbase');
    const nftokenReceiver = ctx.get('protocol').nftokenReceiver.instance.options.address;
...
spec.test('fails when trying to transfer asset to a contract that does not implement receiver', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcert;
    const ledger = ctx.get('ledger');
    const coinbase = ctx.get('coinbase');
...
spec.test('transfer to asset contract that does not implement receiver but is marked as unsafe', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcert;
    const ledger = ctx.get('ledger');
    const coinbase = ctx.get('coinbase');
...
spec.test('transfer approved asset', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcert;
    const ledger = ctx.get('ledger');
    const coinbase = ctx.get('coinbase');
    const bob = ctx.get('bob');
...
spec.test('transfer to approved asset contract that does not implement receiver but is marked as unsafe', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const xcert = ctx.get('protocol').xcert;
    const ledger = ctx.get('ledger');
    const coinbase = ctx.get('coinbase');
    const bob = ctx.get('bob');
