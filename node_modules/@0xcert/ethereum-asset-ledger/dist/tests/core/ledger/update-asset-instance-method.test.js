...
spec.test('update asset imprint', (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield ledger.updateAsset('1', {
        imprint: '0x973124ffc4a03e66d6a4458e587d5d6146f71fc57f359c8d516e0b12a50ab0d7',
    });
    ctx.is(yield xcert.instance.methods.tokenImprint('1').call(), '0x973124ffc4a03e66d6a4458e587d5d6146f71fc57f359c8d516e0b12a50ab0d7');
}));
