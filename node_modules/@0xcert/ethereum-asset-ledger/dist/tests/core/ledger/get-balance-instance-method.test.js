...
spec.test('returns accounts balance', (ctx) => __awaiter(this, void 0, void 0, function* () {
...
spec.test('returns null balance on smart contract that does not support getBalance', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const provider = ctx.get('provider');
