...
spec.test('returns ledger transfer state', (ctx) => __awaiter(this, void 0, void 0, function* () {
...
spec.test('returns null transfer state on contract that does not support transfer states', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const provider = ctx.get('provider');
    const ledgerId = ctx.get('protocol').erc721Enumerable.instance.options.address;
    const ledger = new ledger_1.AssetLedger(provider, ledgerId);
    ctx.is(yield ledger.isTransferable(), null);
}));
exports.default = spec;
//# sourceMappingURL=get-transfer-state-instance-method.test.js.map