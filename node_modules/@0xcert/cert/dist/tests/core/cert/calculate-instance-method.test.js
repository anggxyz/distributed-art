...
spec.test('imprints complete data object', (ctx) => __awaiter(this, void 0, void 0, function* () {
...
spec.test('validates selected paths', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const cert = new cert_1.Cert({
        schema: schemas_1.defaultSchema,
    });
...
spec.test('validates selected nested paths', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const cert = new cert_1.Cert({
        schema: schemas_1.defaultSchema,
    });
    const recipes = yield cert.disclose(schemas_1.defaultData, [
...
spec.test('fails when data includes more data then exposed', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const cert = new cert_1.Cert({
        schema: schemas_1.defaultSchema,
    });
    const recipes = yield cert.disclose(schemas_1.defaultData, [
...
spec.test('pass on custom properties not defined by schema', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const cert = new cert_1.Cert({
        schema: schemas_1.defaultSchema,
    });
    const recipes = yield cert.disclose(schemas_1.defaultData, [
...
spec.test('pass on preliminary array and following object empty fields', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const cert = new cert_1.Cert({
        schema: schemas_1.defaultSchema,
    });
    const data = {
