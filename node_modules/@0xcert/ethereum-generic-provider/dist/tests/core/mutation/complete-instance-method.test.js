...
spec.test('times out when valid timeout value', (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    const mutation = new __1.Mutation(provider, 'fakehash');
    yield ctx.throws(() => mutation.complete());
...
spec.test('does not time out when timeout is -1', (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    const started = Date.now();
    const mutation = new __1.Mutation(provider, 'fakehash');
    yield ctx.throws(() => promised_timeout_1.timeout({
...
//# sourceMappingURL=complete-instance-method.test.js.map