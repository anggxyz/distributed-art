...
spec.test('empty array', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const values = [];
...
spec.test('array with element A', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const values = ['A'];
    const recipe = yield ctx.get('merkle').notarize(values);
    ctx.deepEqual(recipe, {
        values: [
...
spec.test('recipe for values A,B,C,D', (ctx) => __awaiter(this, void 0, void 0, function* () {
...
spec.test('hasher function receives value, path and position parameters', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const values = ['A', 'B'];
    const hashings = [];
...
spec.test('with prepended path', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const values = ['A'];
    const hashings = [];
    const merkle = new __1.Merkle({
        hasher: (v, p, n) => {
...
spec.test('recipe with custom noncer function', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const values = ['A', 'B'];
    const merkle = new __1.Merkle({
...
spec.test('noncer function receives path parameter', (ctx) => __awaiter(this, void 0, void 0, function* () {
    const values = ['A', 'B'];
    const noncing = [];
    const merkle = new __1.Merkle({
        noncer: (p) => {
